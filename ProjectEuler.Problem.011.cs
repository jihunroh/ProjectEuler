...
01 70 54 71 83 51 54 69 16 92 33 48 61 43 52 01 89 19 67 48";
        ...
        public static System.Collections.Generic.IEnumerable<int?> LargestProductInCell (short[][] numberGrid)
        {
            ...
            for (int x = 0; x < xMax; x++)
            {
                ...
                {
                    products = new int?[] { Down(numberGrid, x, y), Right(numberGrid, x, y), LeftDown(numberGrid, x, y), RightDown(numberGrid, x, y) };
                    yield return products.Max();
                }
            }
        }
        public static int? Down(short[][] grid, int x, int y)
        {
        ...
        public static int? Right(short[][] grid, int x, int y)
        {
            int xMax = grid.Length;
            int yMax = grid[0].Length;
               if (x + 3 >= yMax)
        ...
        public static int? LeftDown(short[][] grid, int x, int y)
        {
            int xMax = grid.Length;
            int yMax = grid[0].Length;
            if (x - 3 < 0 || y + 3 >= yMax)
        ...
        public static int? RightDown(short[][] grid, int x, int y)
        {
            int xMax = grid.Length;
            int yMax = grid[0].Length;
